...
exports.sourceNodes = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref2, _ref3) {
    ...
    var _ref3$apiURL = _ref3.apiURL,
        ...
        _ref3$graphqlTypes = _ref3.graphqlTypes,
        graphqlTypes = _ref3$graphqlTypes === undefined ? [] : _ref3$graphqlTypes,
    ...
    var createNode, deleteNode, touchNode, jwtToken, fetchActivity, contentTypePromises, singleTypePromises, graphqlTypePromises, entities, newNodes, existingNodes, diff;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            graphqlTypePromises = graphqlTypes.map(function (graphqlType) {
              return (0, _fetch2.default)({
                apiURL: apiURL,
            ...
            _context.next = 11;
            return _promise2.default.all([].concat((0, _toConsumableArray3.default)(contentTypePromises), (0, _toConsumableArray3.default)(singleTypePromises), (0, _toConsumableArray3.default)(graphqlTypePromises)));
          ...
          case 14:
            ...
            contentTypes.concat(singleTypes).concat(graphqlTypes).forEach(function (contentType, i) {
              var items = entities[i];
              items.forEach(function (item) {
                var type = typeof contentType === 'string' ? contentType : contentType.type;

                var node = (0, _nodes.Node)((0, _lodash.capitalize)(type), item);
